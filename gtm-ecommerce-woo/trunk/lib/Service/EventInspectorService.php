...
<?php if ($this->wpSettingsUtil->getOption("event_inspector_demo_mode") === '1'): ?>
	<div>To learn more about tracking performance <a href="https://app.tagconcierge.com/?demo=woo-free" target="_blank">see DEMO of Tag Concierge App</a> that is a separate product that can integrate with this plugin.</div>
<?php endif ?>
